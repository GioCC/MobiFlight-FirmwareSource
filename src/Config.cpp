...
void readInts(uint8_t nparms, char *params, volatile uint16_t *paddr)
{
    while (nparms-- > 0) {
        *params++ = readUintFromEEPROM(paddr);
    }
}
